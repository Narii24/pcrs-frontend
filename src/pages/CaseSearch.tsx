      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-12">
          <h1 className="text-3xl font-black italic tracking-tighter uppercase">
            Intelligence <span className="text-blue-500">Directory</span>
          </h1>
          {globalSearch && (
        ...
        {loading ? (
          <div className="text-center py-20 animate-pulse text-blue-500 font-black uppercase">Scanning Database...</div>
        ) : (
            ...
            {filteredCases.map((item) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <span className="bg-blue-500/10 text-blue-400 text-[10px] font-black px-3 py-1 rounded-full border border-blue-500/20 uppercase tracking-tighter">{item.caseType || 'GENERAL'}</span>
                ...
                <div className="pt-4 border-t border-white/5 flex justify-between items-center">
                  ...
                  <button className="text-blue-500 text-[9px] font-black uppercase tracking-widest">Open Dossier →</button>
                </div>
              </div>
            ))}
          </div>
        ...
        {!loading && filteredCases.length === 0 && (
          <div className="text-center py-24 opacity-20">
            <p className="text-4xl font-black italic uppercase italic">No Records Found</p>
          </div>
        )}
      </div>
    </div>
