  ...
  return (
    <div className="p-8 bg-[#06080f] min-h-screen text-white">
      <div className="mb-10 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
        <div>
          <h2 className="text-3xl font-black italic uppercase">New Intelligence Cases</h2>
          <p className="text-[10px] text-blue-500 font-bold uppercase mt-2">Verified Database Records</p>
        </div>
              ...
              >
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4 text-[10px] font-bold text-slate-500 uppercase">
                    <span>
                      Loc: <span className="text-slate-300">{c.location}</span>
                    </span>
                    <span className="w-1 h-1 bg-slate-700 rounded-full" />
                    <span>
                      Type: <span className="text-slate-300">{c.caseType}</span>
                    </span>
                  </div>
                </div>
                <button
